...
public final class PersistenceException extends RuntimeException {
  ...
  private static final String FIND_BY_ID_FAILED_MESSAGE =
          "Failed to find user with ID: '%s'.";

  private static final String FIND_BY_EMAIL_FAILED_MESSAGE =
          "Failed to find user with email: '%s'.";

  private static final String FIND_ALL_FAILED_MESSAGE =
          "Failed to retrieve all users.";

  private static final String DELETE_FAILED_MESSAGE =
